...
| 問題 | 答案 |
|------|------|
| 有沒有命中率 75%+ 的條件？ | 有，但 573 萬個假設裡只剩 **11 組** 過得了四道關卡；而且**跨季驗證 0 組存活** |
...
| 對左右投 / 對球種 / 日夜場分項有用嗎？ | 三個獨立實驗都說沒有：消融實驗只有球場天氣顯著；**只用 16 個「莊家一定知道」的欄位，模型表現和 109 欄完整版一樣好**；跨季驗證 53 萬組高命中條件 0 組存活 |
