...
NUM_FEATURES_TG = [
    ...
    ("my_woba_l15", "我隊近15場 wOBA"),
    ("my_woba_vsL_l15", "我隊近15場對左投 wOBA"),
    ("my_woba_vsR_l15", "我隊近15場對右投 wOBA"),
    ("my_xwoba", "我隊 xwOBA(接觸品質)"),
    ("my_bp_woba_30d", "我隊牛棚30天被打 wOBA"),
    ...
    ("my_sp_whiff", "我隊先發揮空率"),
    ("my_sp_xwoba", "我隊先發被打 xwOBA"),
    ("my_sp_last3_r9", "我隊先發近3場 R/9"),
    ("my_sp_last3_ip", "我隊先發近3場局數"),
    ("my_runs_std15", "我隊得分波動度"),
    ...
    ("op_woba_l15", "對手近15場 wOBA"),
    ("op_woba_vsL_l15", "對手近15場對左投 wOBA"),
    ("op_woba_vsR_l15", "對手近15場對右投 wOBA"),
    ("op_xwoba", "對手 xwOBA(接觸品質)"),
    ("op_bp_woba_30d", "對手牛棚30天被打 wOBA"),
    ...
    ("op_sp_whiff", "對手先發揮空率"),
    ("op_sp_xwoba", "對手先發被打 xwOBA"),
    ("op_sp_last3_r9", "對手先發近3場 R/9"),
    ("op_sp_last3_ip", "對手先發近3場局數"),
...
NUM_FEATURES_G = [
    ...
    ("home_sp_xwoba", "主隊先發被打 xwOBA"),
    ("away_sp_xwoba", "客隊先發被打 xwOBA"),
    ("home_sp_last3_r9", "主隊先發近3場 R/9"),
    ("away_sp_last3_r9", "客隊先發近3場 R/9"),
    ...
    ("home_woba_l15", "主隊近15場 wOBA"),
    ("away_woba_l15", "客隊近15場 wOBA"),
    ("home_bp_woba_30d", "主隊牛棚30天被打 wOBA"),
    ("away_bp_woba_30d", "客隊牛棚30天被打 wOBA"),
    ("total_expect", "推估總分"),
    ("k_sum", "雙方先發 K/9 合計"),
    ("temp", "氣溫"),
    ("park_factor", "球場得分環境"),
